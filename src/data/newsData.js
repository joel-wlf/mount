export default [
  {
    ...
    user: 'Gartenbau',
    type: 'static',
    body: 'über die Pflanzmethoden und die Neuerungen der Software unserer Gewächshäuser besprechen. Alle Dorfbewohner die ein Gewächshaus besitzen (also alle 😀) sind herzlich eingeladen zum Treffen zu kommen. Das Treffen startet nächsten Samstag gegen 10 Uhr. Alle sind herzlich eingeladen Snacks und Dips aus eigenem Anbau Nächsten Samstag lädt der Gartenbauverein zu einem gemeinsamen Treffen ein, wo wir uns mitzubringen. Euer Gartenbauverein',
  },
  {
    title: 'Agrarbericht 2028',
    description:
      'Der Agrarbericht für 2028 ist veröffentlicht und kann aufgerufen werden',
    image: 'agrar.jpg',
    date: '05.12.2028',
    user: 'Bundesagrarminesterium',
    type: 'static',
    body: 'Im Agrarbericht 2028 für unser innovatives Dorf verzeichnen wir beeindruckende Fortschritte. Die Ernteerträge sind um 30% gestiegen, dank fortschrittlicher Anbau-Technologien und nachhaltiger Bewirtschaftungsmethoden. Die Einführung von Smart-Farming-Systemen hat die Effizienz verbessert und den Ressourcenverbrauch reduziert. Zudem haben wir erfolgreich alternative Energiequellen in der Landwirtschaft integriert, was zu einer 40%igen Senkung der CO2-Emissionen geführt hat. Das innovative Dorf zeigt sich als Vorreiter in der nachhaltigen Landwirtschaft, wodurch sowohl ökologische als auch wirtschaftliche Ziele erreicht werden. Der Bericht kann auf der Seite des Bundesagrarministeriums aufgerufen werden.',
  },
  {
